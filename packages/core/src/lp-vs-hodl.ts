...
export function amountsForLiquidity(
  ...
  if (sqrtPriceX96 < sqrtPriceUpperX96) {
    return {
      amount0: (liquidity * (sqrtPriceUpperX96 - sqrtPriceX96) * Q96) / sqrtPriceUpperX96 / sqrtPriceX96,
...
export function analyzeLpVsHodl(input: LpVsHodlInput): LpVsHodlAnalysis {
  ...
  return {
    ...
    divergenceToken1BaseUnits: subtract(lpPrincipalValueToken1BaseUnits, hodlValueToken1BaseUnits),
