...
describe('Robinhood WETH proxy evidence', () => {
  it('pins an upgradeable proxy and keeps it execution ineligible', () => {
    ...
    expect(ROBINHOOD_WETH_PROXY_EVIDENCE.adminOwner.controlStatus).toBe(
      'access-control-role-membership-unresolved',
    )
    expect(ROBINHOOD_WETH_PROXY_EVIDENCE.adminOwner.implementation).toBe(
      '0x3c3E52bC8C181D06A76e2518bBc655C5BB3Ce7Cd',
    )
